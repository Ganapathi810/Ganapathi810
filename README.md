...
🎓 I am a graduate with a degree in Computer Science and Engineering, and skilled in building responsive, dynamic, performant, scalable web apps using modern web technologies such as **Next.js**, **MERN stack**, **Shadcn UI** and **TailwindCSS**,.I am comfortable in both frontend and backend. Other backend technologies I am familiar with, include FastAPI, python, postgres + prismaORM
